...
Be sure to check the :doc:`/contribute/manual/guides/writing_guide`
for conventions and :doc:`/contribute/manual/guides/markup_guide`
...
To view your changes, build the manual :doc:`as instructed </contribute/manual/getting_started/build>`.
