...
free and open source extensions compatible with Blender's license: `GNU General Public License v3.0 or later <https://spdx.org/licenses/GPL-2.0-or-later.html>`__.
...
The initial list of compatible licenses which are supported are:
