...
The painting functionality in Sculpt Mode is limited to a :doc:`Paint </sculpt_paint/sculpting/tools/paint>` 
...
.. note::
   Once any painting tool is executed, the :ref:`viewport color shading <viewport_shading_solid_color>` is switched to “Attribute”. 
